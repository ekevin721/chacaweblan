...
<!-- Especialidades -->
<div id="Especialidades"  class="barra" > <!--col-md-12 Esp-->
    <center>
  <div class="container" id="tabla">
    <h1 class="titulo11">ESPECIALIDADES</h1>
      <?php
...
<div id="Novedades" class="barra">
        
	<center>
			
			<div class="container" id="tabla">
			<h1 class="titulo11">NOVEDADES</h1> 
...
<div id="ComunicadosAnteriores" class="barra">
   <center>
	 <div class="container" id="tabla">
	     <h1 class="titulo11">COMUNICADOS ANTERIORES</h1> 
...
<footer id="fondo" class="page-footer font-small red pt-4">
